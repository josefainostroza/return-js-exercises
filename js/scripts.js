...
function numberDivision(number) {
  if (number % 3 === 0 && number % 5 === 0) {
    return number + ' es divisible por ambos';
  } else if (number % 3 === 0) {
...
const division = numberDivision(15);
console.log(division);

function evenOldNumber(number) {
  if (number % 2 === 0) {
...
const oldNumber = evenOldNumber(3);
console.log(oldNumber);

function leapYear(number) {
  if ((number % 4 === 0 && number % 100 !== 0) || number % 400 === 0) {
    return number + ' es año bisiesto';
  } else {
    return number + ' no es año bisiesto';
  }
}
